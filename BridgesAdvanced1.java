 ...
 */
public class BridgesAdvanced1 extends JPanel
    ...
    */
    ...
    protected void paintComponent(Graphics g) {
        ...
        String turn = cpuThinking ? "Computer thinking (D&C + DP)..." :
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            BridgesAdvanced1 gamePanel = new BridgesAdvanced1();
